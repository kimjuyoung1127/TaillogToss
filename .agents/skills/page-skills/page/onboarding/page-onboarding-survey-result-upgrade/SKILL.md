---
name: page-onboarding-survey-result-upgrade
description: Page-level hardening workflow for /onboarding/survey-result (Survey Result). Use this when improving UI/UX and feature completeness for this route only.
---

# page-onboarding-survey-result-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/onboarding/survey-result`.
- UI/UX hardening is requested for Survey Result page.

## Input Context
- Route: `/onboarding/survey-result`
- Page file: `src/pages/onboarding/survey-result.tsx`
- Parity: UI-001
- Priority: P1
