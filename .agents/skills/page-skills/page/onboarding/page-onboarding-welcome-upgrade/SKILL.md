---
name: page-onboarding-welcome-upgrade
description: Page-level hardening workflow for /onboarding/welcome (Welcome). Use this when improving UI/UX and feature completeness for this route only.
---
...
- UI/UX hardening is requested for Welcome page.
