---
name: page-coaching-result-upgrade
description: Page-level hardening workflow for /coaching/result (Coaching Result). Use this when improving UI/UX and feature completeness for this route only.
---

# page-coaching-result-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/coaching/result`.
- UI/UX hardening is requested for Coaching Result page.

## Input Context
- Route: `/coaching/result`
- Page file: `src/pages/coaching/result.tsx`
- Parity: UIUX-005, AI-001
- Priority: P0
