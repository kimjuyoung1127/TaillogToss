---
name: page-settings-subscription-upgrade
description: Page-level hardening workflow for /settings/subscription (Subscription). Use this when improving UI/UX and feature completeness for this route only.
---

# page-settings-subscription-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/settings/subscription`.
- UI/UX hardening is requested for Subscription page.

## Input Context
- Route: `/settings/subscription`
- Page file: `src/pages/settings/subscription.tsx`
- Parity: IAP-001
- Priority: P1
