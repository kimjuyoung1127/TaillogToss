---
name: page-training-detail-upgrade
description: Page-level hardening workflow for /training/detail (Training Detail). Use this when improving UI/UX and feature completeness for this route only.
---

# page-training-detail-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/training/detail`.
- UI/UX hardening is requested for Training Detail page.

## Input Context
- Route: `/training/detail`
- Page file: `src/pages/training/detail.tsx`
- Parity: UIUX-005
- Priority: P0
