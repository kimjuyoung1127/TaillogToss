---
name: page-onboarding-survey-upgrade
description: Page-level hardening workflow for /onboarding/survey (Survey). Use this when improving UI/UX and feature completeness for this route only.
---

# page-onboarding-survey-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/onboarding/survey`.
- UI/UX hardening is requested for Survey page.

## Input Context
- Route: `/onboarding/survey`
- Page file: `src/pages/onboarding/survey.tsx`
- Parity: UIUX-004
- Priority: P0
