---
name: page-legal-privacy-upgrade
description: Page-level hardening workflow for /legal/privacy (Privacy). Use this when improving UI/UX and feature completeness for this route only.
---

# page-legal-privacy-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/legal/privacy`.
- UI/UX hardening is requested for Privacy page.

## Input Context
- Route: `/legal/privacy`
- Page file: `src/pages/legal/privacy.tsx`
- Parity: APP-001
- Priority: P2
