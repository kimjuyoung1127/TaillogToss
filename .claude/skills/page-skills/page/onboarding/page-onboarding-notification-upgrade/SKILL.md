---
name: page-onboarding-notification-upgrade
description: Page-level hardening workflow for /onboarding/notification (Notification). Use this when improving UI/UX and feature completeness for this route only.
---

# page-onboarding-notification-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/onboarding/notification`.
- UI/UX hardening is requested for Notification page.

## Input Context
- Route: `/onboarding/notification`
- Page file: `src/pages/onboarding/notification.tsx`
- Parity: APP-001
- Priority: P1
