---
name: page-dashboard-upgrade
description: Page-level hardening workflow for /dashboard (Dashboard). Use this when improving UI/UX and feature completeness for this route only.
---

# page-dashboard-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/dashboard`.
- UI/UX hardening is requested for Dashboard page.

## Input Context
- Route: `/dashboard`
- Page file: `src/pages/dashboard/index.tsx`
- Parity: UIUX-001
- Priority: P1
