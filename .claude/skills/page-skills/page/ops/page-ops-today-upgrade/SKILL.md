---
name: page-ops-today-upgrade
description: Page-level hardening workflow for /ops/today (Ops Today). Use this when improving UI/UX and feature completeness for this route only.
---

# page-ops-today-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/ops/today`.
- UI/UX hardening is requested for Ops Today page.

## Input Context
- Route: `/ops/today`
- Page file: `src/pages/ops/today.tsx`
- Parity: B2B-001
- Priority: P2
