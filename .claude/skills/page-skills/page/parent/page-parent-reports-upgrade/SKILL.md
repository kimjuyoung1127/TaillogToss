---
name: page-parent-reports-upgrade
description: Page-level hardening workflow for /parent/reports (Parent Reports). Use this when improving UI/UX and feature completeness for this route only.
---

# page-parent-reports-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/parent/reports`.
- UI/UX hardening is requested for Parent Reports page.

## Input Context
- Route: `/parent/reports`
- Page file: `src/pages/parent/reports.tsx`
- Parity: B2B-001
- Priority: P2
