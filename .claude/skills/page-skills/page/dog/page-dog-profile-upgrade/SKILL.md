---
name: page-dog-profile-upgrade
description: Page-level hardening workflow for /dog/profile (Dog Profile). Use this when improving UI/UX and feature completeness for this route only.
---

# page-dog-profile-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/dog/profile`.
- UI/UX hardening is requested for Dog Profile page.

## Input Context
- Route: `/dog/profile`
- Page file: `src/pages/dog/profile.tsx`
- Parity: UIUX-006
- Priority: P0
