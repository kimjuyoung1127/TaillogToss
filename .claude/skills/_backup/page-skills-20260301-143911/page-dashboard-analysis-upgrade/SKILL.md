---
name: page-dashboard-analysis-upgrade
description: Page-level hardening workflow for /dashboard/analysis (Analysis). Use this when improving UI/UX and feature completeness for this route only.
---

# page-dashboard-analysis-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/dashboard/analysis`.
- UI/UX hardening is requested for Analysis page.

## Input Context
- Route: `/dashboard/analysis`
- Page file: `src/pages/dashboard/analysis.tsx`
- Parity: UIUX-001
- Priority: P0
