---
name: page-training-academy-upgrade
description: Page-level hardening workflow for /training/academy (Academy). Use this when improving UI/UX and feature completeness for this route only.
---

# page-training-academy-upgrade

## Trigger
- User asks to improve, polish, fix, or complete route `/training/academy`.
- UI/UX hardening is requested for Academy page.

## Input Context
- Route: `/training/academy`
- Page file: `src/pages/training/academy.tsx`
