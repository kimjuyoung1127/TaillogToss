...
**보상형 광고 퍼널**: Skeleton 블러 → TextButton("광고 보고 열기") → 토스 Ads SDK 2.0 Rewarded (→ AdMob 폴백) → 1회 해제 → "매번 광고 귀찮다 → PRO 구독" 자연 전환
...
**B2B 자동 전환**: v1 숨김 (Phase 7+). B2B 플랜(훈련사 PRO ₩19,900/월, 센터 PRO ₩49,900/월) 별도 릴리즈 예정
**구독 만료**: role 유지, 기록/리포트 생성 차단, 기존 데이터 열람 30일 유예
...
**광고 SDK**: 토스 Ads SDK 2.0 Rewarded 우선 → AdMob 자동 폴백. 테스트 ID: `ait-ad-test-rewarded-id`
